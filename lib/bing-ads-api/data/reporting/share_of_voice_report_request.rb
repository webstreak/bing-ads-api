...
module BingAdsApi
  ##
  # Public: Reporting service request object for a share of voice report.
  #
  # Author:: colin.knox@offers.com
  #
  class ShareOfVoiceReportRequest < BingAdsApi::PerformanceReportRequest
    # Valid Columns for this report request
    COLUMNS = BingAdsApi::Config.instance.
      reporting_constants['share_of_voice_report']['columns']

    # Valid Filters for this report request
    FILTERS = BingAdsApi::Config.instance.
      reporting_constants['share_of_voice_report']['filter']
